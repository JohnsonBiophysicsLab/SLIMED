...
// get_subdivision_matrices() retired by WP5. The valence-5 literals it held
// now live in tests/subdivision_oracle.cpp as the permanent oracle for
// build_subdivision_matrices(); production builds them for any valence.
